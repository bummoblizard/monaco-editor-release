...
define("vs/editor/editor.main.nls", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Controls whether to show inline completions in the editor.",
		"Controls whether the ghost text that is used by the suggestion preview or the inline completions is expanted by default.",
	...
	"vs/editor/common/view/editorColorRegistry": [
		...
		"Border color of inline suggestion preview in the editor.",
		"Opacity of inline suggestion preview in the editor. For example, \"#000000c0\" will render the code with 75% opacity. For high contrast themes, use the  'editorSuggestPreview.border' theme color instead of fading it out.",
	...
	"vs/editor/contrib/inlineCompletions/ghostTextController": [
		"Whether inline suggestions are visible",
		"Whether the inline suggestion suggests extending indentation",
